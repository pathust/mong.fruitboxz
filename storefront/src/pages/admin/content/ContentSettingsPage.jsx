  ...
  return (
    <div className="space-y-3 relative">
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute z-10 top-full left-0 right-0 mt-2 bg-white/95 backdrop-blur-md rounded-2xl border border-[#eadfcd] shadow-2xl max-h-[300px] overflow-y-auto overflow-x-hidden animate-in fade-in slide-in-from-top-2 p-1.5 custom-scrollbar">
            {loading ? (
