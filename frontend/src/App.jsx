    ...
    <Routes>
      ...
      <Route path="/admin" element={<AdminAuthProvider><AdminLoginCheck /></AdminAuthProvider>}>
        ...
        <Route element={<ProtectedRoute><AdminLayout /></ProtectedRoute>}>
          ...
          <Route path="customers/:id" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="customers.read"><CustomerDetail /></RequirePermission></Suspense>} />
          <Route path="promotions" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="promotions.read"><PromotionsList /></RequirePermission></Suspense>} />
          <Route path="inventory" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="inventory.read"><InventoryList /></RequirePermission></Suspense>} />
          <Route path="products" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="products.read"><ProductsList /></RequirePermission></Suspense>} />
          <Route path="products/new" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="products.read"><ProductForm /></RequirePermission></Suspense>} />
          <Route path="products/:id" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="products.read"><ProductForm /></RequirePermission></Suspense>} />
          <Route path="categories" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="categories.read"><CategoriesList /></RequirePermission></Suspense>} />
          <Route path="categories/new" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="categories.read"><CategoryForm /></RequirePermission></Suspense>} />
          <Route path="categories/:id" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="categories.read"><CategoryForm /></RequirePermission></Suspense>} />
          ...
          <Route path="orders" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="orders.read"><OrdersList /></RequirePermission></Suspense>} />
          <Route path="orders/:id" element={<Suspense fallback={<ScreenLoader />}><RequirePermission perm="orders.read"><OrderDetail /></RequirePermission></Suspense>} />
