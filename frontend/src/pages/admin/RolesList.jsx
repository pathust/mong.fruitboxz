...
const REGISTRY_MODULES = [
  ...
  { key: "permissions", label: "Quyền hạn (Hệ thống)" },
  ...
  { key: "content", label: "Nội dung tĩnh & Chính sách" },
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white rounded-2xl border border-[#eadfcd] shadow-sm flex flex-col">
        ...
        <div className="p-5 border-b border-[#eadfcd] bg-[#fffaf4]/10">
            ...
            {REGISTRY_MODULES.map((moduleGroup) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-full border px-4 py-2 text-[13px] font-bold transition-all ${active ? "border-primary bg-primary text-white shadow-md shadow-primary/20" : "border-[#eadfcd] bg-white text-[#766957] hover:border-primary/40 hover:bg-[#fffaf4]"}`}>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[800px] text-sm">
            <thead className="bg-[#fffaf4] border-b border-[#eadfcd]">
              <tr>
