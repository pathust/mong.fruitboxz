...
export default function SearchConsole() {
  ...
  const handleReindex = async () => {
    ...
    try {
      ...
      pushToast(error?.message || 'Reindex thất bại. Frontend vẫn dùng fallback catalog.', 'error')
    } finally {
      setReindexing(false)
    }
  }
            ...
            <ul className="space-y-5">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#766957] mt-1 leading-relaxed">Nếu MeiliSearch chưa online, Frontend sẽ tự động dùng tính năng lọc nội bộ để không làm gián đoạn khách hàng.</p>
                </div>
              </li>
              <li className="flex gap-4">
