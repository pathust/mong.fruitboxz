        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="text-lg font-bold text-white">Mọng</span>
                <span className="text-lg text-gray-300 ml-1">| Trái cây gọt sẵn</span>
              </div>
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Mọng là thương hiệu trái cây gọt sẵn chất lượng cao, với đa dạng sản phẩm phục vụ mọi nhu cầu: đặc sản vùng miền, trái cây nhập khẩu, quà tặng trái cây, và nhiều hơn nữa.
            </p>
            <div className="space-y-2 text-sm text-gray-400">
              ...
              <p className="flex items-center gap-2">
                ...
                {settings.phone || '0945.204.432 - 0943.284.386'}
              </p>
              <p className="flex items-center gap-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                {settings.email || 'info@mongfruitbox.com'}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              <a href={settings.instagram || 'https://www.instagram.com/mong.fruitboxz'} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-700 hover:bg-gradient-to-br hover:from-pink-500 hover:to-purple-500 rounded-full flex items-center justify-center text-gray-300 hover:text-white transition-all">
              ...
              <a href="https://www.tiktok.com/@mong.fruitboxz" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-700 hover:bg-black rounded-full flex items-center justify-center text-gray-300 hover:text-white transition-all">
