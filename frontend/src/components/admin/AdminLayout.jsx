...
const navGroups = [
  {
    ...
    items: [
      ...
      { label: "Tài chính", path: "/admin/finance", icon: WalletCards, permission: "finance.read" },
    ],
  },
  {
    label: "Bán hàng",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Bài viết Blog", path: "/admin/blog", icon: FileText, permission: "blog.read" },
      { label: "Danh mục Blog", path: "/admin/blog-categories", icon: FolderKanban, permission: "blog-categories.read" },
      { label: "CS Thanh toán", path: "/admin/content/payment-policy", icon: FileText, permission: "content.read" },
      { label: "CS Bảo mật", path: "/admin/content/privacy-policy", icon: Shield, permission: "content.read" },
      { label: "CS Vận chuyển", path: "/admin/content/shipping-policy", icon: Truck, permission: "content.read" },
    ],
  },
  {
    label: "AI & Khám phá",
