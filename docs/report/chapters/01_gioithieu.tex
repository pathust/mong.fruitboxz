...
\begin{itemize}[leftmargin=2em, itemsep=3pt]
  ...
  \item Tách biệt rõ giao diện, API, nghiệp vụ và hạ tầng để thuận tiện bảo trì và triển khai.
\end{itemize}
...
\begin{longtable}{@{}L{0.22\textwidth} L{0.70\textwidth}@{}}
  ...
  Biên tập viên & Quản lý banner, bài viết, media, nội dung chính sách và FAQ/chatbot khi được cấp quyền nội dung tương ứng. \\[3pt]
  Quản lý cửa hàng & Vận hành catalog, đơn hàng, khách hàng, khuyến mãi, tồn kho, nguyên liệu và báo cáo kinh doanh. \\[3pt]
  Super Admin & Có toàn quyền hệ thống, đặc biệt là quản lý người dùng nội bộ, vai trò, quyền hạn, cấu hình giao hàng và các thiết lập quan trọng. \\[3pt]
