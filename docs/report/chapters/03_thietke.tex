...
Medusa cung cấp các mô-đun lõi như Product, Pricing, Inventory, Order, Customer, User, Promotion và Region. Báo cáo tập trung vào bốn mô-đun mở rộng đang tham gia trực tiếp vào luồng chức năng hiện hành:
...
Khi người dùng chọn vị trí hiện tại, trình duyệt trả tọa độ cho frontend. Frontend gọi reverse geocode để điền địa chỉ có thể đọc được; thay đổi của địa chỉ hoặc tọa độ kích hoạt yêu cầu báo phí sau 300 ms. API sử dụng cấu hình điểm xuất phát, danh sách quận miễn phí và công thức khoảng cách để trả phí cùng \texttt{mode}. Checkout API vẫn tính lại cùng quy tắc khi tạo đơn, vì số tiền hiển thị phía client không phải nguồn dữ liệu tin cậy.
