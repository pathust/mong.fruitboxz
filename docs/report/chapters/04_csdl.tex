...
\begin{itemize}[leftmargin=2em, itemsep=4pt]
  ...
  \item \texttt{vote}: lưu customer\_id, product\_id, score và comment cho chức năng chấm điểm độc lập.
\end{itemize}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{images/erd.drawio.png}
...
Migration mới nhất loại bỏ bảng \texttt{site\_review}; các migration cũ vẫn được giữ lại như lịch sử tiến hóa lược đồ để một cơ sở dữ liệu mới có thể tái hiện đúng chuỗi thay đổi và kết thúc ở trạng thái không còn chức năng review.
