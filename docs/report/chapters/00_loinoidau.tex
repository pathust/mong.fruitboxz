...
Về kỹ thuật, hệ thống sử dụng \techterm{React}, \techterm{Vite} và \techterm{Tailwind CSS} cho giao diện; \techterm{Medusa.js v2} và \techterm{Node.js} cho backend; \techterm{PostgreSQL}, \techterm{Redis}, \techterm{Meilisearch} và \techterm{MinIO} cho hạ tầng dữ liệu. Kiến trúc headless commerce tách phần giao diện khỏi lõi nghiệp vụ, đồng thời tận dụng các mô-đun thương mại điện tử có sẵn của Medusa và mở rộng bằng các mô-đun riêng của cửa hàng.

Báo cáo được chỉnh sửa sau khi rà soát mã nguồn tại thời điểm tháng 6 năm 2026. Nội dung vì vậy tập trung vào những phần đã có trong dự án, các điểm còn thiếu và những việc có thể làm tiếp.

Em xin chân thành cảm ơn giảng viên hướng dẫn, thầy \textbf{Lê Tấn Hùng}, đã hỗ trợ và tạo điều kiện trong quá trình thực hiện đề tài.
